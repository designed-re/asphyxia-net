...
namespace luna.Migrations
{
    ...
    [Migration("20260124130919_2600124-musecaDB")]
    partial class _2600124musecaDB
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("luna.Utils.Models.museca.MusecaItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int(11)")
                    ...
                    b.HasIndex(new[] { "Profile" }, "FK_museca_profile_to_profile(id)");

                    b.ToTable("museca_items", null, t =>
                        {
                            t.HasComment("Data store(Items) for Museca");
                        });
                });

            modelBuilder.Entity("luna.Utils.Models.museca.MusecaProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int(11)")
                    ...
                    b.Property<int>("GamecoinBlock")
                        .HasColumnType("int(11)")
                        .HasColumnName("gamecoin_block");

                    b.Property<int>("GamecoinPacket")
                        .HasColumnType("int(11)")
                    ...
                    b.Property<int>("PacketBooster")
                        .HasColumnType("int(11)")
                        .HasColumnName("packet_booster");

                    b.Property<int>("PlayChain")
                        .HasColumnType("int(11)")
                    ...
                    b.ToTable("museca_profile", null, t =>
                        {
                            t.HasComment("Data store(Profile) for Museca");
                        });
                });

            modelBuilder.Entity("luna.Utils.Models.museca.MusecaScore", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int(11)")
                    ...
                    b.HasIndex(new[] { "Profile" }, "FK_museca_score_profile_to_profile(id)");

                    b.ToTable("museca_scores", null, t =>
                        {
                            t.HasComment("Data store(Scores) for Museca");
                        });
                });

            modelBuilder.Entity("luna.Utils.Models.sdvx.SvCourseRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int(11)")
            ...
            modelBuilder.Entity("luna.Utils.Models.sdvx.SvEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int(11)")
            ...
            modelBuilder.Entity("luna.Utils.Models.sdvx.SvItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int(11)")
            ...
            modelBuilder.Entity("luna.Utils.Models.sdvx.SvMatchmaker", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int(11)")
            ...
            modelBuilder.Entity("luna.Utils.Models.sdvx.SvMusic", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int(11)")
            ...
            modelBuilder.Entity("luna.Utils.Models.sdvx.SvParam", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int(11)")
            ...
            modelBuilder.Entity("luna.Utils.Models.sdvx.SvProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int(11)")
            ...
            modelBuilder.Entity("luna.Utils.Models.sdvx.SvRival", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int(11)")
            ...
            modelBuilder.Entity("luna.Utils.Models.sdvx.SvScore", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int(11)")
            ...
            modelBuilder.Entity("luna.Utils.Models.sdvx.SvValgeneTicket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int(11)")
            ...
            modelBuilder.Entity("luna.Utils.Models.museca.MusecaItem", b =>
                {
                    b.HasOne("luna.Utils.Models.museca.MusecaProfile", "ProfileNavigation")
                        .WithMany("MusecaItems")
            ...
            modelBuilder.Entity("luna.Utils.Models.sdvx.SvCourseRecord", b =>
                {
                    b.HasOne("luna.Utils.Models.sdvx.SvProfile", "ProfileNavigation")
            ...
            modelBuilder.Entity("luna.Utils.Models.sdvx.SvMatchmaker", b =>
                {
                    b.HasOne("luna.Utils.Models.sdvx.SvProfile", null)
            ...
            modelBuilder.Entity("luna.Utils.Models.sdvx.SvProfile", b =>
                {
                    b.HasOne("luna.Utils.Models.Card", "CardNavigation")
                        .WithOne("SvProfile")
                        .HasForeignKey("luna.Utils.Models.sdvx.SvProfile", "Card")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("luna.Utils.Models.sdvx.SvScore", b =>
                {
                    b.HasOne("luna.Utils.Models.sdvx.SvMusic", "Music")
                        .WithMany("SvScores")
            ...
            modelBuilder.Entity("luna.Utils.Models.museca.MusecaProfile", b =>
                {
                    b.Navigation("MusecaItems");

                    b.Navigation("MusecaScores");
                });
